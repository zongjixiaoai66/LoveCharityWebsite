<template>
    <div style="backgroundImage: url('/lvchengzhengzhouaixingongyi/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">绿城郑州爱心公益网站注册</h1>
