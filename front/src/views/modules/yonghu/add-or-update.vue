        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="身份" prop="yonghuTypes">
                        <el-select v-model="ruleForm.yonghuTypes" :disabled="ro.yonghuTypes" placeholder="请选择身份">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="身份" prop="yonghuValue">
