...
public class FuwuxinxiLiuyanView extends FuwuxinxiLiuyanEntity implements Serializable {
	...
	public FuwuxinxiLiuyanView() {

	}

	public FuwuxinxiLiuyanView(FuwuxinxiLiuyanEntity fuwuxinxiLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, fuwuxinxiLiuyanEntity);
