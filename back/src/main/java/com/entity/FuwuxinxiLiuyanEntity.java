...
public class FuwuxinxiLiuyanEntity<T> implements Serializable {
     ...
     * 留言内容
     */
    @TableField(value = "fuwuxinxi_liuyan_text")

    private String fuwuxinxiLiuyanText;
	 ...
	 * 设置：留言内容
	 */
    public String getFuwuxinxiLiuyanText() {
        return fuwuxinxiLiuyanText;
    }
    /**
	 * 获取：留言内容
	 */

    public void setFuwuxinxiLiuyanText(String fuwuxinxiLiuyanText) {
        this.fuwuxinxiLiuyanText = fuwuxinxiLiuyanText;
    }
    /**
	 * 设置：留言时间
	 */
    ...
    public String toString() {
        return "FuwuxinxiLiuyan{" +
            "id=" + id +
            ", fuwuxinxiId=" + fuwuxinxiId +
            ", yonghuId=" + yonghuId +
            ", fuwuxinxiLiuyanText=" + fuwuxinxiLiuyanText +
